package ma.project.voiture.controllers;
...
import ma.project.voiture.services.ClientService;
import ma.project.voiture.services.VoitureService;
...
public class VoitureController {
    ...
    public List<Voiture> getVoitures() {
        ...
        voitures.forEach(v -> {
            // ⚠ bien utiliser le bon getter selon ton champ : clientId ou id_client
            Long clientId = v.getClientId(); // ou v.getId_client()
            if (clientId != null) {
